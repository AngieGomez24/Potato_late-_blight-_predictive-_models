...
# Instanciar el modelo con 10 arboles de decisión
...
# guardar
joblib.dump(model, "./RF_color_v2.joblib", compress=3)
...
matrix = plot_confusion_matrix(model, X_test, y_test,
                                 cmap=plt.cm.Blues)
plt.title('Confusion matrix for our classifier RF Color')
plt.show(matrix)
plt.show()

#Cargar modelo
#loaded_rf = joblib.load("./RF_plant_village_1.joblib")
